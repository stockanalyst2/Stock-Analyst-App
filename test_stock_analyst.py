...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn("PRIVATE INVESTMENT OFFICE", document)
        self.assertIn("Capital first. Wait for confirmation.", document)
        self.assertIn("Market Structure", document)
        self.assertIn("Conviction:", document)
        ...
        self.assertIn("Risk Temperature", document)
        ...
        self.assertIn("Atlas Signal <strong>Live Watchlist</strong>", document)
        self.assertIn("PANW", document)
        self.assertIn("Palo Alto Networks", document)
        self.assertIn("Cybersecurity", document)
        self.assertIn("Atlas Signal <strong>Entry Candidate</strong>", document)
        ...
        self.assertIn("Open Dossier", document)
    ...
    def test_dashboard_uses_latest_report_state_statuses(self):
        ...
        self.assertIn("Atlas Signal <strong>Ready for Entry</strong>", document)
        ...
        self.assertIn("Capital Ledger", document)
    ...
    def test_app_detail_html_uses_new_streamlined_template(self):
        ...
        self.assertIn("Atlas Signal", document)
        self.assertIn("Current Thesis", document)
        self.assertIn("Entry Conditions", document)
        self.assertIn("Contract Exposure", document)
        self.assertIn("Risk Profile", document)
        self.assertIn("Invalidation", document)
        self.assertIn("Return to Private Office", document)
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("<title>ATLAS Intelligence Dossier</title>", document)
    ...
    def test_atlas_journal_html_renders_daily_success_rates(self):
        ...
        self.assertIn("Daily Ledger", document)

...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn(">Journal</button>", document)
        self.assertIn(">Research</button>", document)
        self.assertIn('"Avenir Next", "Helvetica Neue", Helvetica, Arial, sans-serif', document)
        self.assertIn("border-radius: 12px 12px 0 0", document)
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("padding: 0 20px 92px", document)
        self.assertIn("max-width: 560px", document)
        self.assertIn("min-height: 112px", document)
        self.assertIn("grid-template-columns: minmax(0, 1fr) 104px 52px", document)
        self.assertIn("grid-template-columns: minmax(0, 1fr) 88px 46px", document)
        self.assertIn("font-weight: 640", document)

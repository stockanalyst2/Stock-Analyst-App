...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn('src="/static/logos/ABNB.png"', document)
        self.assertIn('data-jpg-src="/static/logos/ABNB.jpg"', document)
        self.assertIn('data-svg-src="/static/logos/ABNB.svg"', document)
        ...
        self.assertIn("this.dataset.usedSvg", document)
    ...
    def test_app_detail_html_uses_new_streamlined_template(self):
        ...
        self.assertIn("Return to Watchlist", document)

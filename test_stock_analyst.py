...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("grid-template-columns: 78px 92px minmax(18px, 1fr) 78px 16px", document)
        self.assertIn("grid-template-columns: 72px 92px minmax(14px, 1fr) 76px 18px", document)

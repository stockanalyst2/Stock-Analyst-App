...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("grid-template-columns: 92px 92px minmax(18px, 1fr) 78px 8px 16px", document)
        self.assertIn("grid-template-columns: 86px 90px minmax(10px, 1fr) 76px 8px 18px", document)

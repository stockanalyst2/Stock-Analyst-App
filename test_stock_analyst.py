...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn("<h1>Watchlist</h1>", document)
        ...
        self.assertIn('data-panel-content="news"', document)
        self.assertIn('data-panel-content="search"', document)
        self.assertIn('data-panel-content="profile"', document)
        self.assertIn("showSubpanel", document)
        self.assertIn('aria-label="Watchlist"', document)
        self.assertIn('aria-label="News"', document)
        self.assertIn('aria-label="Search"', document)
        ...
        self.assertIn("width: min(760px, calc(100vw - 24px))", document)
        self.assertIn("backdrop-filter: blur", document)
        self.assertIn("grid-template-columns: repeat(3, 1fr)", document)
        self.assertIn("border-bottom: 1px solid rgba(255, 255, 255, .11)", document)
        self.assertIn("stock-card-main", document)
        self.assertIn("stock-card-detail", document)
        self.assertIn("panelContents", document)

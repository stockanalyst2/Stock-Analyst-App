...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("min-height: 100px", document)
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(104px, auto) 46px", document)
        self.assertIn("gap: 24px", document)

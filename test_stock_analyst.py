...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn("max-width: 522px", document)
        self.assertIn("min-height: 98px", document)
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(112px, auto) 50px", document)

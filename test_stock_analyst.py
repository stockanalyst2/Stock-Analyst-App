...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn(">Options</button>", document)
        self.assertIn(">Roth IRA</button>", document)
        self.assertIn(">Christian</button>", document)
        self.assertIn(">Investing</button>", document)
        self.assertIn(">Agentic</button>", document)
        ...
        self.assertIn('data-subpanel-content="roth-ira"', document)
        self.assertIn('data-subpanel-content="agentic"', document)
        ...
        self.assertIn("justify-content: space-between", document)
    ...
    def test_report_header_omits_old_logo(self):
        ...
        self.assertIn('class="account-group-header"', document)
        self.assertIn("ATLAS account", document)
        self.assertIn("0 items", document)
        self.assertIn("min-height: 86px", document)
        self.assertIn("grid-template-columns: minmax(118px, 1fr) 142px 118px 34px", document)
        self.assertIn(".sparkline", document)
        self.assertIn("scrollIntoView", document)
        self.assertIn("atlas-subpanel-swipe", document)
        self.assertIn("atlas-report-scroll", document)
        self.assertIn("font-weight: 450", document)

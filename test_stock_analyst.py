...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn(">Custom Watchlist</button>", document)
        ...
        self.assertIn("padding: 54px 27px 138px", document)
        self.assertIn("padding: 54px 20px 138px", document)
        self.assertIn("width: min(553px, calc(100vw - 54px))", document)
        self.assertIn("bottom: 50px", document)
        self.assertIn("background: rgba(2, 3, 7, .84)", document)
        self.assertIn("height: calc(100dvh - 455px)", document)
        self.assertIn("min-height: 360px", document)

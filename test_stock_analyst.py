...
class StockAnalystTests(unittest.TestCase):
    ...
    def test_dashboard_html_exposes_app_controls(self):
        ...
        self.assertIn("padding: 68px 27px 114px", document)
        self.assertIn("padding: 68px 20px 114px", document)
        ...
        self.assertIn("min-height: 48px", document)
        self.assertIn("width: 34px", document)

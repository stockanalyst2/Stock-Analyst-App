...
<head>
  ...
  <style>
    ...
    @media (max-width: 520px) {{ main {{ padding: 0 0 100px; }} .setup-summary {{ min-height: 94px; grid-template-columns: 104px 76px 96px 18px; gap: 22px; }} .setup-summary-actions {{ width: 18px; }} .summary-symbol {{ font-size: 19px; font-weight: 400; }} .summary-company {{ margin-top: 8px; font-size: 12px; max-width: 100px; }} .sparkline {{ width: 76px; height: 36px; }} .quote-block {{ min-width: 96px; min-height: 38px; padding: 0 8px; }} .quote-price {{ font-size: 17px; font-weight: 400; }} .vital-grid {{ grid-template-columns: 1fr; }} }}
    @media (max-width: 390px) {{ .setup-summary {{ grid-template-columns: 86px 62px 82px 16px; min-height: 84px; gap: 17px; }} .setup-summary-actions {{ width: 16px; }} .summary-symbol {{ font-size: 17px; }} .summary-company {{ font-size: 11px; max-width: 82px; }} .sparkline {{ width: 62px; height: 32px; }} .quote-block {{ min-width: 82px; min-height: 34px; }} .quote-price {{ font-size: 15px; }} }}
  </style>
</head>
<body>
  <main>

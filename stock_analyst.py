...
<head>
  ...
  <style>
    ...
    .setup-summary {{ display: grid; grid-template-columns: minmax(0, 1fr) minmax(116px, auto) 58px; align-items: center; min-height: 112px; gap: 14px; padding: 0 0 0 18px; background: transparent; border-bottom: 0; }}
